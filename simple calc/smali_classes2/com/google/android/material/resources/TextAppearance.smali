...
.method public getFont(Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    .line 15
    .line 16
    invoke-static {v0, p1}, Le1/f;->a(ILandroid/content/Context;)Landroid/graphics/Typeface;
...
.method public getFontAsync(Landroid/content/Context;Lcom/google/android/material/resources/TextAppearanceFontCallback;)V
    ...
    sget-object v1, Le1/f;->a:Ljava/lang/ThreadLocal;
    ...
    .line 10
    invoke-virtual {v5, p1, v1}, Le1/f$e;->callbackFailAsync(ILandroid/os/Handler;)V
    ...
    invoke-static/range {v1 .. v7}, Le1/f;->b(Landroid/content/Context;ILandroid/util/TypedValue;ILe1/f$e;ZZ)Landroid/graphics/Typeface;
    :try_end_0
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
