...
.field public final m:Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$a;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$a;Lr2/c$a;Z)V
    .locals 7
    ...
    .line 15
    .line 16
    invoke-direct {v6, p4, p3}, Ls2/c;-><init>(Lr2/c$a;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$a;)V
    ...
    .line 24
    .line 25
    iput-object p1, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->f:Landroid/content/Context;

    .line 26
    .line 27
    iput-object p3, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->m:Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$a;

    .line 28
    .line 29
    iput-object p4, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->n:Lr2/c$a;
    ...
    .line 46
    .line 47
    invoke-static {p2, p4}, Lc8/g;->e(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 57
    .line 58
    iput-object p3, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->q:Lt2/a;
...
# virtual methods
.method public final c(Z)Lr2/b;
    .locals 3

    .line 1
    iget-object v0, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->q:Lt2/a;
    ...
    .line 17
    :goto_0
    invoke-virtual {v0, v1}, Lt2/a;->a(Z)V
    ...
    .line 21
    .line 22
    invoke-virtual {p0, p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->q(Z)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 32
    .line 33
    invoke-virtual {p0, p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->c(Z)Lr2/b;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0, v1}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->d(Landroid/database/sqlite/SQLiteDatabase;)Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;
...
.method public final close()V
    ...
    .line 10
    .line 11
    iget-object v1, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->m:Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$a;
    ...
    .line 17
    iput-boolean v1, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->r:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final d(Landroid/database/sqlite/SQLiteDatabase;)Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;
    ...
    .line 5
    .line 6
    iget-object v0, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->m:Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$a;
...
.method public final onConfigure(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 7
    .line 8
    iget-object v1, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->n:Lr2/c$a;
    ...
    .line 28
    invoke-virtual {v1, p1}, Lr2/c$a;->b(Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 6
    :try_start_0
    iget-object v0, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->n:Lr2/c$a;
    ...
    .line 12
    invoke-virtual {v0, p1}, Lr2/c$a;->c(Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 15
    invoke-virtual {v0, p1, p2, p3}, Lr2/c$a;->d(Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 16
    invoke-virtual {v0, p1}, Lr2/c$a;->e(Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 15
    invoke-virtual {v0, p1, p2, p3}, Lr2/c$a;->f(Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final q(Z)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 6
    .line 7
    iget-object v2, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->f:Landroid/content/Context;
    ...
    .line 80
    .line 81
    iget-object v4, v1, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper$CallbackException;->f:Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper$CallbackName;
    ...
    .line 90
    iget-object v1, v1, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper$CallbackException;->m:Ljava/lang/Throwable;
    ...
    .line 129
    iget-object p1, p1, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper$CallbackException;->m:Ljava/lang/Throwable;
